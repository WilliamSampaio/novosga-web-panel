        ...
        <template v-slot:default="{ isActive }">
          <v-card>
            <v-card-text class="flex flex-column justify-center">
              <v-switch
                class="mx-auto"
                :label="$t('settings.label.dark_mode')"
                density="compact"
      ...
      <v-row>
        <v-col cols="12">
          <v-card
            ...
            :title="$t('menu.server')"
            :subtitle="$t('settings.server.subtitle')"
          >
            <v-divider></v-divider>
            ...
            <v-card-text>
              <v-select
                ...
                density="compact"
                :label="$t('settings.label.novosga_version')"
              ...
              >
                <v-text-field
                  ...
                  :label="$t('settings.label.server_url')"
                ...
                <v-text-field
                  ...
                  :label="$t('settings.label.api_user')"
                ...
                <v-text-field
                  ...
                  :label="$t('settings.label.api_password')"
                ...
                <v-text-field
                  ...
                  :label="$t('settings.label.api_client_id')"
                ...
                <v-text-field
                  ...
                  :label="$t('settings.label.api_client_secret')"
                ...
                <v-text-field
                  ...
                  :label="$t('settings.label.retries')"
              ...
              <!-- <div v-else-if="serverStore.apiVersion !== null && serverStore.apiVersion === '22'">
                <v-alert type="warning" variant="tonal" density="comfortable">
                  {{ $t('settings.server.novosga_22_unavailable') }}
                </v-alert>
              </div> -->
            </v-card-text>
          ...
          >
            ...
            <v-card-text>
              ...
              <div v-if="settingsStore.services.length > 0">
                <v-switch
                  :label="$t('settings.label.select_all')"
          ...
          >
            ...
            <v-card-text>
              <v-select
                ...
                :label="$t('settings.label.panel_model')"
                prepend-icon="mdi-panorama-outline"
                density="compact"
              >
              </v-select>
            ...
            <v-card-text>
              <v-text-field
                ...
                :label="$t('settings.label.header_logo_url')"
              ...
              <v-text-field
                ...
                :label="$t('settings.label.footer_left_logo_url')"
                prepend-icon="mdi-image"
                density="compact"
                clearable
              >
              ...
              <v-text-field
                ...
                :label="$t('settings.label.footer_right_logo_url')"
                prepend-icon="mdi-image"
                density="compact"
                clearable
              >
              ...
              <v-switch
                ...
                :label="$t('settings.label.show_footer_clock')"
                density="compact"
              >
              </v-switch>
              ...
              <v-switch
                ...
                :label="$t('settings.label.show_history_local')"
                density="compact"
              >
              </v-switch>
            </v-card-text>
              ...
              <v-row>
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.header_bg_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.header_text_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.main_bg_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.ticket_label_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.ticket_text_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.ticket_priority_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.service_text_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.local_text_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.history_bg_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.history_text_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.history_empty_text_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.footer_bg_color')"
                  />
                </v-col>
                ...
                <v-col cols="4">
                  <ColorInput
                    ...
                    :label="$t('settings.label.footer_text_color')"
                  />
                </v-col>
              </v-row>
            </v-card-text>
          ...
          >
            ...
            <v-card-text>
              <v-select
                ...
                :label="$t('settings.label.alert_sound')"
              ...
              <v-switch
                ...
                :label="$t('settings.label.enable_speech')"
                density="compact"
              >
                <template v-slot:append>
                  <v-text-field
                    v-model="speechTestString"
                    :label="$t('settings.label.speech_phrase')"
                    :placeholder="$t('settings.placeholder.speech_phrase')"
                    maxlength="24"
                    density="compact"
                    class="w-96"
                  >
              ...
              <v-row no-gutters>
                <v-col cols="12" md="8">
                  <div class="text-subtitle-1 font-weight-bold mb-1">
                    {{ $t('settings.critical.reset_title') }}
                  </div>
                  <p class="text-body-2 text-medium-emphasis">
                    {{ $t('settings.critical.reset_description') }}
                  </p>
                </v-col>
...
const speechTestString = ref(t('settings.speech.test_text'))
...
const saveServerSettings = async () => {
  try {
    ...
    messages.add({ text: t('settings.server.save_success'), color: 'success' })
  } catch (error) {
    messages.add({
      text: t('settings.server.save_error', { message: error.message }),
      color: 'error',
    })
  }
}
...
watch(
  ...
  () => {
    ...
    timer = setTimeout(() => {
      panelStore.save()
      messages.add({ text: t('settings.save_success'), color: 'success' })
    }, 2000)
  },
  { deep: true },
)
  ...
  if (authStore.isAuthenticated) {
    ...
    if (authStore.isExpired)
      await authStore.refresh().catch(() => {
        messages.add({ text: t('auth.error.session_expired'), color: 'error' })
      })
